...
cout<<"\t\t\t\t\t\tCOPYRIGHT Share Ilmu@2012"<<endl;
cout<<" "<<endl;
cout<<"\t ========================================================"<<endl;
cout<<"\t SELEKSI MAHASISWA BARU UNIVERSITAS TEKNOLOGI YOGYAKARTA"<<endl;
cout<<"\t ========================================================"<<endl;
ulang:
...
cout<<"selamat anda dinyatakan DITERIMA di Universitas Teknologi Yogyakarta";
}
